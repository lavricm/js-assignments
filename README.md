[![Brest Rollingg Scopes](http://brest.rollingscopes.com/images/logo_rs_text.svg)](http://brest.rollingscopes.com/)
#Brest Rolling Scopes School
## Javascript Assignments  [![Build Status](https://travis-ci.org/lavricm/js-assignments.svg?branch=master)](https://travis-ci.org/lavricm/js-assignments)
...
* Edit local README.md file and update all links (just replace all occurrences of `'lavricm'` with your account name).
...
```
* Open https://github.com/lavricm/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/lavricm/js-assignments/builds).
